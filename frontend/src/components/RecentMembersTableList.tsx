...
import { useDeleteMemberMutation, useRecentMemberQuery, useUpdateMemberMutation } from "@/api/member-query"
...
export default function RecentMembersTableList() {
  ...
  const memberQuery = useRecentMemberQuery(authQuery.data?.user?.userId, page, 5)
